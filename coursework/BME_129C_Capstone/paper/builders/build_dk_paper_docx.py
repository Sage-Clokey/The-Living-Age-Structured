...
"""
build_paper_docx.py
Converts distributed_knowledge_paper.md into a formatted Word document (.docx).
...
INPUT_MD = SCRIPT_DIR / "distributed_knowledge_paper.md"
OUTPUT_DOCX = SCRIPT_DIR / "distributed_knowledge_paper.docx"
