...
Bioinformatics background with training at the University of California, Santa Cruz — one of the preeminent genomics and bioinformatics institutions in the world, home of the UCSC Genome Browser (used by >300,000 researchers worldwide). Fluency in Python, R, and C; experience with genome retrieval systems (UCSC client, NCBI client), compatibility analysis pipelines, and adaptive assembly engines. The existing codebase demonstrates production-quality implementation of codon optimization, regulatory element analysis, and pathway conflict detection — the foundation Phase I builds upon.
