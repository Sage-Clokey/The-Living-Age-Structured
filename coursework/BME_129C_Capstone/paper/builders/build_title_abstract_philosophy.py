"""
Build Title and Abstract DOCX — pure philosophy version.
Arial 11, single-spaced per BME129C_slides_051126.pdf guidelines.

Usage: python paper/build_title_abstract_philosophy.py
"""
...
OUT = Path(__file__).resolve().parent.parent / "title_and_abstract_philosophy.docx"
...
def build():
    ...
    abstract = (
        ...
        "\n\n"
        "If DNA is a language, the cell speaks it \u2014 and can write in that "
        "language. Bioinformatics is the study of this distributed knowledge in "
        "living systems. Central planning makes the error: treating distributed "
        "knowing as if it could be centrally held, treating knowers as if they "
        "were merely data. Build economies, not machines."
    )
